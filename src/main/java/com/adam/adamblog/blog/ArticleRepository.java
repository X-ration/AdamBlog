...
public class ArticleRepository {
    ...
    public void init() {
        addArticle(new Article("Frank Adam","Adam's Blog正式开通！",
                ...
                CreateArrayList.withStringValues("2018年2月28日，Adam's Blog个人博客站正式开通。",
                        "基于Spring Boot开发和Material Design风格，在简化开发过程的同时不乏美感。"),
                true,"nature.jpg",
        ...
        addArticle(new Article("IT之家","Windows 7依然是第一游戏操作系统！吃鸡玩家立大功",
                ...
                true,"20180303_1.jpg",
                false,"", "",
                LocalDateTime.parse("2016-09-12T12:09:58")));
        addArticle(new Article("IT之家","亚马逊Alexa全球性“罢工",
                ...
                true,"20180303_2.jpg",
                false,"", "",
                LocalDateTime.parse("2018-01-01T03:49:08")));
    }
